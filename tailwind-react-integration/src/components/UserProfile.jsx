function UserProfile() {
    return (
    <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:p-8 lg:p-8 sm:max-w-xs md:max-w-sm lg:max-w-md hover:shadow-xl">
